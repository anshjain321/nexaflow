    ...
    <>
      ...
      bg-white px-7 py-2 shadow-md blackdrop-blur transition-all hover:border-gray-300 hover:bg-white/50"
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Nexaflow allow you to have conversation with any pdf document. simply
          upload your file and start asking question right away
        </p>
        <Link
          className="border-black border-2 px-16 rounded-full mt-8 bg-black flex flex-row py-4 items-center"
          href={"/dashboard"}
          target="'blank"
        >
